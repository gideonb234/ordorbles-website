    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right" id="small-links">
                <li class="small-links-item"><a href="mailto:gideon@ordorbles.uk"><i class="fa fa-envelope"></i></a></li>
                <li class="small-links-item"><a href="http://uk.linkedin.com/in/gideonbrett"><i class="fa fa-linkedin"></i></a></li>
                <li class="small-links-item"><a href="http://twitter.com/ordorbles"><i class="fa fa-twitter" ></i></a></li>
                <li class="small-links-item"><a href="http://github.com/gideonb234"><i class="fa fa-github"></i></a></li>
